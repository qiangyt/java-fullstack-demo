...
<template>
  <div style="margin-top: 50px;">
    ...
    <el-dialog v-model="newPostDialogVisible" title="发表新留言" width="800">
      <el-form :model="newPostForm" @submit.native.prevent="submitNewPost">
        <el-form-item label="内容" :error="newPostError">
          <el-input type="textarea" v-model="newPostForm.content" maxlength="200" show-word-limit
            @input="checkNewPostLength"></el-input>
    ...
    <el-dialog v-model="newCommentDialogVisible" title="发表新评论" width="800">
      <el-form :model="newCommentForm" @submit.native.prevent="submitNewComment">
        <el-form-item label="内容" :error="newCommentError">
          <el-input type="textarea" v-model="newCommentForm.content" maxlength="200" show-word-limit
            @input="checkNewCommentLength"></el-input>
